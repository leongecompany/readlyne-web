...
export default function FeaturesPage() {
  ...
  const features = cn ? [
    { title: '信号检测', desc: 'AI 分析聊天中的语气、互动模式和参与度，判断积极、中性还是危险信号。' },
    ...
    { title: 'Signal Detection', desc: 'AI analyzes tone, engagement, and interaction patterns to identify positive, neutral, or warning signals.' },
