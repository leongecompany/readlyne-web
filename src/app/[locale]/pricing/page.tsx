...
export default function PricingPage() {
  ...
  const t = cn ? {
    ...
    deep_name: 'Deep Strategy Pack',
    deep_price: 'A$9.99',
    deep_desc: '5 full reports',
    deep_items: ['目标可行性分析', '沟通状态评估', '时间线互动节奏', '5条心理学策略', '3条定制回复', '信号追踪 + 风险提醒'],
    payment: '付款由 Stripe 安全处理，支持信用卡和支付宝。价格为澳元（A$），按实时汇率换算。',
    faq1_q: '免费次数用完了怎么办？',
    faq1_a: '购买标准包（A$4.99/10次）即可继续使用。需要深度策略请购买深度策略包（A$9.99/5次）。',
    faq2_q: '可以退款吗？',
    ...
    payment: 'Payments processed securely by Stripe. Credit cards and Alipay supported. All prices in Australian Dollars (A$).',
    faq1_q: 'What happens when free runs out?',
    faq1_a: 'Buy Standard Pack (A$4.99/10) to continue. For deep strategy, buy the Deep Strategy Pack (A$9.99/5).',
    faq2_q: 'Refunds?',
