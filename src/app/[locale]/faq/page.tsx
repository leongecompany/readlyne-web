...
export default function FaqPage() {
  ...
  const faqs = cn ? [
    { q: '懂了么 是什么？', a: 'AI 聊天洞察助手。粘贴聊天内容，分析信号、意图、风险和回复技巧。' },
    { q: '收费吗？', a: '基础分析完全免费。无需注册，无需付费。' },
    { q: '怎么付款？', a: '目前完全免费，无需付款。' },
    { q: '聊天内容安全吗？', a: '内容实时分析后不保存。你粘贴的内容不会被用于训练 AI 模型。' },
    { q: '能替代心理咨询吗？', a: '不能。懂了么 提供 AI 生成的参考建议，不替代专业心理咨询。' },
    { q: '可以退款吗？', a: '目前免费使用，无需退款。' },
    { q: '支持哪些平台？', a: '网页版和 iOS App。Android 暂不支持。' },
    { q: '如何删除数据？', a: '发邮件到 privacy@readlyne.com，14 天内处理。' },
  ] : [
    { q: 'What is Readlyne?', a: 'AI-powered relationship communication assistant. Paste chats for signal analysis, intention detection, risk assessment, and reply suggestions.' },
    { q: 'How much does it cost?', a: 'Basic analysis is completely free. No sign-up, no payment required.' },
    { q: 'How do I pay?', a: 'Currently free to use. No payment needed.' },
    ...
    { q: 'Can I get a refund?', a: 'Free to use, no refunds needed.' },
